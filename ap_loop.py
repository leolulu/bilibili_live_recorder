...
scheduler.add_job(search_flv_transform, cron_search_flv_transform, ["//192.168.123.44/LiveRecord/22128636-OakNose", "//192.168.123.44/LiveRecord/12572155-腾讯研究院"], coalesce=True, misfire_grace_time=60)
